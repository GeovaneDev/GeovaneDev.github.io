      ...
      <main className="flex-grow pt-20">
        <section className="container mx-auto px-4 py-32 flex flex-col items-center relative">
          ...
          <div className="text-center space-y-10 max-w-4xl mx-auto relative z-10">
            <h1 className="text-7xl md:text-8xl font-bold bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-500 text-transparent bg-clip-text animate-gradient tracking-tight">
              GeovaneSec
            </h1>
            <p className="text-2xl md:text-3xl text-gray-300 leading-relaxed max-w-3xl mx-auto font-light">
        ...
        <section className="container mx-auto px-4 py-24 relative" id="projects">
          ...
          <h2 className="text-5xl font-bold mb-20 text-center relative">
            <span className="relative pb-4 bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-500 text-transparent bg-clip-text">
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-cyan-500 to-blue-500"></div>
            </span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {projects.map((project, index) => (
              <div 
                key={index} 
                className="group relative overflow-hidden project-card bg-gradient-to-br from-gray-800/30 to-gray-900/30 p-10 rounded-2xl transition-all duration-500 backdrop-blur-xl border border-gray-700/20 hover:border-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/10 transform hover:-translate-y-2"
              >
                ...
                <div className="flex items-center justify-between mb-8 relative">
                  <div className="text-cyan-400 text-3xl transition-all duration-500 transform group-hover:scale-110 group-hover:text-cyan-300">
                    <FontAwesomeIcon icon={project.icon} className="w-12 h-12" />
                  </div>
                ...
                <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-500 text-transparent bg-clip-text">
                  {project.title}
                </h3>
                <p className="text-gray-300 mb-8 leading-relaxed min-h-[4rem] text-lg">{project.description}</p>
                
                <div className="flex flex-wrap gap-3 mb-8">
                  {project.tags.map((tag, tagIndex) => (
                    <span 
                      key={tagIndex}
                      className="px-5 py-2 text-sm bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl text-cyan-300 border border-cyan-500/20 shadow-lg shadow-cyan-500/5 hover:from-cyan-500/20 hover:to-blue-500/20 transition-colors duration-300"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex gap-4 mt-auto">
                  {project.demoEnabled && (
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer" 
                      className="flex-1 py-3 px-6 text-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-cyan-500/25"
                    >
                      Ver Site
                    </a>
                  )}
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer" 
                    className="flex-1 py-3 px-6 text-center rounded-xl bg-gradient-to-r from-gray-800/80 to-gray-900/80 text-white font-medium hover:from-gray-700 hover:to-gray-800 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-gray-700/25 border border-gray-600/20"
                  >
                    Ver Código Fonte
                  </a>
                </div>
